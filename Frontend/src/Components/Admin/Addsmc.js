        ...
        <div className='flex items-center'>
            ...
            <div className="App w-full flex justify-center items-center h-[500px]">
                <div className='shadow-lg   sm:w-4/6	 md:w-1/2 lg:w-1/2 shadow-md rounded px-8 pt-6  pb-8'>
                    <h1 className='text-center m-5 text-xl text-orange font-bold'>Management Commitee  </h1>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label className="block text-gray-700 text-sm font-bold  " htmlFor="addressInput">Address</label><br></br>
                            <input
                                className="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"

                                type="text" id="addressInput" value={address} onChange={handleAddressChange} />
                        </div>
