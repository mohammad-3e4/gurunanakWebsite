  ...
  return (
    <>
      ...
      <div className='fixed z-50 w-full'>
        ...
        {/* *******************************************Header******************************** */}
        <header
          className="shadow px-0 w-full  bg-orange   py-2 md:py-4 lg:py-4"

        >
          <div className="w-full  container mx-auto px-4 md:px-6 lg:px-8 block sm:flex items-center justify-between ">
            <div className="w-full  md:w-[60%] flex items-center ">
              <img
                className="h-10 md:h-12 lg:h-16 mr-2 hidden lg:block "
                src="./images/school_logo.png"
                alt="Logo"
              />
              <h1 className="tracking-widest pt-3 mb-2 text-[15px] xs:text-[18px] sm:text-[15px] md:text-xl lg:text-3xl font-bold tracking-tight text-white">
                GURU NANAK KHALSA SR. SEC. SCHOOL
              </h1>
            </div>
            <div className='  w-full md:w-[40%] flex justify-end'>
              {/* <Link to="/" className="me-2 px-4 py-2 bg-orange text-white rounded-lg hover:text-orange hover:bg-white">Pay Online</Link> */}
              
              <Link to="/donate" className="transition font-semibold duration-400 text-center mb-2 sm:mb-0 px-10 py-2 w-full sm:w-[50%] bg-white text-orange rounded-md ">Donate</Link>
            </div>
          </div>
        </header>
        ...
        <header className={`bg-white  shadow w-full transition-all duration-300 ${
        ...
        isNavbarVisible ? "transform translate-y-0" : "transform -translate-y-full"
          ...
          <nav className="mx-auto flex max-w-[100%]  items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
              <Link to="#" className="-m-1.5 py-1">
                <span className="sr-only">Your Company</span>
                <img
                  className="h-10 w-11 lg:hidden"
                  src='./images/school_logo.png'
                  alt=""
                />
              </Link>
            ...
            <Popover.Group className="hidden  w-full  flex items-center justify-center  z-20 lg:flex lg:gap-x-4 2xl:gap-x-8">
              <Link to="/" className="text-md   hover:text-orange font-semibold leading-6 text-orange transition duration-400">
                Home
              </Link>
              <Popover className="relative ">
                <Popover.Button onMouseEnter={() => setIsOpen(true)}
                  onMouseLeave={() => setIsOpen(false)} className="flex outline-none   hover:text-orange items-center gap-x-1 text-md font-semibold leading-6 text-blue transition duration-400">
                  Our School
                      ...
                      {ourschool.map((item) => (
                        ...
                        >
                          ...
                          <div className="flex-auto">
                            <Link to={item.href} className="block font-semibold text-white hover:text-orange transition duration-500">
                              {item.name}
              ...
              {/* ////////////////////////////////////////////////////// */}
              <Popover className="relative">
                <Popover.Button onMouseEnter={() => setIsOpen2(true)}
                  onMouseLeave={() => setIsOpen2(false)} className="flex outline-none hover:text-orange items-center gap-x-1 text-md font-semibold leading-6 text-blue transition duration-400">
                  Management
                  <ChevronDownIcon className="h-5 w-5 flex-none text-orange" aria-hidden="true" />
                </Popover.Button>
              ...
              <Link to="/principal_desk" className="text-md hover:text-orange font-semibold leading-6 text-blue transition duration-400">
                Principal's Desk
              </Link>

              {/* ////////////////////////////////////////////////////// */}
              <Popover className="relative">
                <Popover.Button onMouseEnter={() => setIsOpen3(true)}
                  onMouseLeave={() => setIsOpen3(false)} className="flex outline-none  hover:text-orange items-center gap-x-1 text-md font-semibold leading-6 text-blue transition duration-400">
                  Admission
                  <ChevronDownIcon className="h-5 w-5 flex-none text-orange" aria-hidden="true" />
                </Popover.Button>
              ...
              <Popover className="relative">
                <Popover.Button onMouseEnter={() => setIsOpen4(true)}
                  onMouseLeave={() => setIsOpen4(false)} className="flex outline-none hover:text-orange items-center gap-x-1 text-md font-semibold leading-6 text-blue transition duration-400">
                  Academics
                  <ChevronDownIcon className="h-5 w-5 flex-none text-orange" aria-hidden="true" />
                </Popover.Button>
              ...
              <Link to="/gallery" className="text-md hover:text-orange font-semibold leading-6 text-blue transition duration-400">
                Gallery
              </Link>

              {/* ////////////////////////////////////////////////////// */}
              <Popover className="relative">
                <Popover.Button onMouseEnter={() => setIsOpen5(true)}
                  onMouseLeave={() => setIsOpen5(false)} className="flex outline-none hover:text-orange items-center gap-x-1 text-md font-semibold leading-6 text-blue transition duration-400">
                  Recruitment
                  <ChevronDownIcon className="h-5 w-5 flex-none text-orange" aria-hidden="true" />
                </Popover.Button>
              ...
              <Link to="/news_updates" className="text-md hover:text-orange font-semibold leading-6 text-blue transition duration-400">
                News Updates
              </Link>
              <Link to="/contact" className="text-md  text-blue   hover:text-orange font-semibold leading-6 transition duration-400 ">
                Contact Us
              </Link>
              <Popover className="relative">
                <Popover.Button onMouseEnter={() => setIsOpen6(true)}
                  onMouseLeave={() => setIsOpen6(false)} className="flex outline-none hover:text-orange items-center gap-x-1 text-md font-semibold leading-6 text-blue transition duration-400">
                      ...
                      {({ open }) => (
                        <>
                          <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-blue hover:bg-gray-100">
                            Our School
                            <ChevronDownIcon
                              className={classNames(open ? 'rotate-180' : '', 'h-5 w-5 text-orange flex-none')}
                              aria-hidden="true"
                            />
                          </Disclosure.Button>
                        ...
                        <>
                          ...
                          Admin Login
                           {/* <UserCircleIcon className="h-6 w-6 mx-3" aria-hidden="true" /> */}
                            <ChevronDownIcon
                              className={classNames(open ? 'rotate-180' : '', 'h-5 w-5 text-white flex-none')}
                              aria-hidden="true"
                            />
                          </Disclosure.Button>
                          <Disclosure.Panel className="mt-2 space-y-2">
